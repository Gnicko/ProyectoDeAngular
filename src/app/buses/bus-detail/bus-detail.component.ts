...
export class BusDetailComponent implements OnInit {
  ...
  buildForm(bus: Bus | null) {
    if (bus != null) {
      ...
      this.cargarBuilFormModelo(bus.getModel().getBrand().getId())
  ...
  findBrandForName(name: string) {
    ...
    this.cargarBuilFormModelo(idBrand);
  ...
  cargarBuilFormModelo(idBrand: number) {
    //buscar los models
    this.modelService.findOne(idBrand).subscribe(models => {
